...
from GymSharp import TicTacToeSharpGenericEnvironment
from GymSharp import TupleHelper

"""A CSharp environment for Tic-Tac-Toe game."""
class TicTacToeGenericEnvironment(py_environment.PyEnvironment):
  ...
  def __init__(self, rng: np.random.RandomState=None, discount=1.0):
     super(TicTacToeGenericEnvironment, self).__init__()
     sharp_env = TicTacToeSharpGenericEnvironment(rng, discount)
